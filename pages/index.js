            ...
            <Container maxWidth="lg">
                ...
                <Grid container direction={'column'}>
                    ...
                    <Grid item xs>
                        ...
                        <Typography variant="h1" component="h1" sx={{my: 2, fontFamily: 'Fjalla One', color: 'white'}}> Kyle
                            Smigelski </Typography>
                        </motion.div>
                    </Grid>
                    <Grid item xs>
                    <Typography variant="h5" component="h5" gutterBottom sx={{color: 'grey'}}> Grand Valley State
                        University 2020 - 2024</Typography>
                    <Typography variant="h4" component="h4" gutterBottom sx={{my: 4, color: 'white'}}> I am a current
